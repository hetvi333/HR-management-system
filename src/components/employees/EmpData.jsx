      ...
      <div className="px-8 py-3">
        ...
        <div className={`md:px-6`}>
          <div className="py-6 gap-4 md:gap-0 flex flex-col justify-center items-center md:flex-row md:justify-between md:items-end">
            <div
              className={`flex items-center justify-center text-2xl  rounded-2xl border  w-32 h-32 md:w-24 md:h-24 ${
                toggle
                  ? "bg-transparent border-[#575f68] text-white "
          ...
          <div className={`grid grid-cols-12 gap-3 md:gap-6`}>
            ...
            <input
              ...
              className={`col-span-12 border md:col-span-6 rounded-lg p-4 ${
                toggle
                  ? "bg-transparent border-[#575f68] placeholder:text-gray-200"
                  : ""
              }`}
            />
            <input
